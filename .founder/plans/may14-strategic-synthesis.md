...
**Recommendation if Branch 4 fires:** P4 first (cheapest, fastest, falsifiable in 14d). If P4 also produces 0 signal, escalate severity 6 → 8 and trigger company-survival review.
