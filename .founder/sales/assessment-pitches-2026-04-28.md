# AI Operations Assessment — Personalized Outreach (3 pitches)

**Date:** 2026-04-28
**Sender:** iam@armando.mx (Armando)
**Offer:** $997 AI Operations Assessment (https://www.midastools.co/ai-audit)
**Stripe link:** https://buy.stripe.com/cNi14m90j6iR7OI8VYcMM03
**Why these 3:** Highest-confidence subscriber profiles with multiple distinct AI-replaceable workflows. Picked from the 20 enriched profiles in `.founder/data/subscribers/`.

---

## Pitch #1 — Negar / Hiedeh Tavassoli (Real Estate, North Vancouver)
...
## Pitch #2 — Doug Courter (Pastor + IT Instructor, Hagerstown MD)
...
## Pitch #3 — Christopher Pham via C. Brannan (IP/Brand Protection Law, Woodland Hills CA)

**To:** cbrannan@criterioncounsel.com
**CC:** (let recipient forward to partner — easier than guessing personal email)
...
- **Negar:** Highest-confidence profile (5 corroborating sources). Real estate ICP matches the entire pivot. Bilingual niche is unique angle.
- **Doug:** Highest-confidence non-realtor profile. Tech-literacy = the rare "skip the basics" prospect who'll value the priority matrix instead of a tutorial. Five distinct workflows = ideal assessment candidate.
- **Brannan/Pham:** Senior-partner deal size (legal billing rates make the math trivially favorable). Asynchronous email-to-partner play means low time investment if it doesn't convert. The meta-irony hook is sharp.

## What we're NOT doing (deliberate)

- Sending to free-provider domains (atredesign83@orange.fr, antosoler@outlook.es, dyeaegr9440@wowway.com) — no public surface to research, low confidence on ICP fit.
- Sending to gov domains (shannon.heenan@lakecountyca.gov) — procurement cycle is months, not days.
- Sending to all 20 — quality > volume. If 3 don't bite, we widen.

## Templates this generated

If any reply, drop into:
- `.founder/playbooks/discovery-call-script.md` for the call structure
- `.founder/templates/ai-assessment-report-template.md` for the report scaffold
