...
Format: Friendly but professional. Start with a one-line summary of the week. Use bullet points for progress and next steps. End with a clear ask if a decision is needed, or a simple 'No action needed from your side this week' if not. Under 200 words."`}
        ...
        <div style={{ marginTop: '32px', marginBottom: '32px', padding: '24px', background: '#F0F4FF', border: '1px solid #93B4FF', borderRadius: '8px', textAlign: 'center' }}>
          ...
          <a href={STRIPE_BUNDLE} data-cta="tips-blog-bundle-mid" style={{ display: 'inline-block', background: '#111827', color: '#fff', padding: '14px 28px', borderRadius: '6px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>
...
Show the scoring in a clean table with the final weighted score and a 2-sentence summary.`}
        ...
        <div style={{ marginTop: '48px', padding: '32px', background: '#F0F4FF', border: '1px solid #93B4FF', borderRadius: '8px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', alignItems: 'center' }}>
            ...
            <a href={STRIPE_BUNDLE} data-cta="tips-blog-bundle-bottom" style={{ display: 'inline-block', background: '#111827', color: '#fff', padding: '12px 24px', borderRadius: '6px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>
        ...
        <p style={{ color: '#6B7280', fontSize: '14px' }}>
          <em>Rey Midas builds <a href="https://www.midastools.co" style={{ color: '#3B5FFF' }}>Midas Tools</a> &mdash; AI-powered toolkits for entrepreneurs, creators, and professionals. Questions? <a href="mailto:hello@midastools.co" style={{ color: '#3B5FFF' }}>hello@midastools.co</a>.</em>
        </p>
      </div>
    </Layout>
  );
