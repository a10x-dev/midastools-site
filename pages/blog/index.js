...
const posts = [
  { slug: 'how-to-write-cold-emails-that-get-replies-2026', title: 'How to Write Cold Emails That Get Replies in 2026 (7 Templates + a Free AI Tool)', date: 'May 31, 2026', desc: 'The 4-part structure behind every reply-getting cold email, 7 copy-paste templates, the mistakes that kill your reply rate, and a free AI tool that writes the whole thing for you.' },
  { slug: 'bill-holdings-30-percent-ai-layoffs-finance-operators-2026', title: 'BILL Cut 30% of Staff (709 Jobs) and Announced a $1B Buyback Same Day. Here\'s What Finance Operators Should Actually Do in May 2026.', date: 'May 25, 2026', desc: 'BILL Holdings cut 709 jobs (30% of workforce) on May 7, 2026 and announced a $1B buyback the same morning. CEO René Lacerte: AI is "no longer one priority among three — it is our No. 1 priority." Intuit denied AI at 17%. Salesforce reallocated at 1%. Klarna reversed at 38%. The 4-way 2026 B2B AI-restructuring pattern and the 5-question framework for VP Finance, Controllers, and Heads of FP&A.' },
  { slug: 'intuit-3000-layoffs-b2b-ai-restructuring-2026', title: 'Intuit Cut 3,000 Jobs (17% of Staff). Here\'s What B2B Operators Should Actually Do in May 2026.', date: 'May 22, 2026', desc: 'Intuit laid off 3,000 employees May 20, 2026 — 17% of workforce — and signed Anthropic + OpenAI partnerships the same week. CEO Sasan Goodarzi insists "none of it had to do with AI." Klarna (853 agents replaced, then reversed) and Salesforce (1,000 cut, 2,000 hired for Agentforce) say otherwise. The 5-question framework for VP People, Heads of Ops, and Chiefs of Staff.' },
  { slug: 'ai-adoption-playbooks-compared-2026', title: '5 Enterprise AI Adoption Playbooks Compared: Ramp, Shopify, Klarna, Duolingo, Anthropic (2026)', date: 'May 21, 2026', desc: 'Ramp won. Klarna over-replaced. Duolingo walked back. Shopify mandated. Anthropic dogfooded. Side-by-side comparison of 5 public AI adoption playbooks and the pattern that separates the winners.' },
