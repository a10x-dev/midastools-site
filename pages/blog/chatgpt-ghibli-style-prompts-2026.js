    ...
    <Layout>
      ...
      <div style={sty.article}>
        ...
        <div style={{ marginTop: 24, padding: 32, background: '#F0F4FF', border: '1px solid #93B4FF', borderRadius: 8 }}>
          <h3 style={{ margin: '0 0 8px', fontSize: '1.1rem' }}>Want 145+ Pre-Built Image Prompts?</h3>
          <p style={{ margin: '0 0 16px', color: '#6B7280', fontSize: 15 }}>The <strong>AI Image Prompt Pack</strong> includes 145+ battle-tested prompts — Ghibli, cyberpunk, hyperrealistic, product photography, portraits, and more. Every style, every mood, pre-built and tested. $29 one-time.</p>
