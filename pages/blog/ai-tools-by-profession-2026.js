  ...
  return (
    <Layout>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 24px', fontFamily: 'Georgia, serif', color: '#111827', lineHeight: '1.7' }}>
        ...
        <p>The <strong>AI Prompt Mega Pack</strong> includes 145+ tested prompts organized by profession and use case. Every prompt from every guide above &mdash; plus dozens more &mdash; ready to copy-paste.</p>
        ...
        <p style={{ textAlign: 'center' }}>Or grab the <strong>All Kits Bundle</strong> — 16 kits for $97 (81% off).</p>
