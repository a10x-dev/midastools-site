...
export default function GhibliPromptGenerator() {
  ...
  const handleUnlock = async (e) => {
    ...
    setError('');
    try {
      const res = await submitSubscribe({ email, source: 'ghibli-prompt-generator', referrer: document.referrer || '' });
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{ flex: '1 1 260px', color: '#FFF' }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 700, lineHeight: 1.35 }}>20 hand-picked AI prompts (incl. Ghibli + viral image styles) — instant download.</div>
          </div>
        ...
        <div style={{ textAlign: 'center', marginBottom: 28, marginTop: -16 }}>
          <a href={STRIPE_IMAGE_PACK} data-cta="image-pack-secondary" style={{ color: '#047857', fontSize: 13, fontWeight: 600, textDecoration: 'none', borderBottom: '1px dashed #10B981', paddingBottom: 2 }}>
          ...
          <div>
            ...
            {!unlocked ? (
              ...
              <div style={{ background: '#FFF', border: '2px solid #059669', borderRadius: 16, padding: 32 }}>
                ...
                <a
                  href="/ai-art-generator?utm_source=ghibli-generator&utm_medium=cta&utm_campaign=art-machine-bridge&style=ghibli"
                ...
                >
                  <span style={{ display: 'block', fontSize: 15, fontWeight: 800, color: '#FFF', marginBottom: 3 }}>✨ New — skip the copy-paste. Make the actual image here.</span>
                  <span style={{ fontSize: 13, color: '#DBE4FF' }}>Turn this into a finished Ghibli image right on MidasTools — free →</span>
                </a>

                <div style={{ background: '#ECFDF5', borderRadius: 12, padding: 16, marginBottom: 24 }}>
                  <p style={{ fontWeight: 700, fontSize: 15, color: '#065F46', margin: '0 0 6px' }}>Prefer to do it yourself? How to use this prompt:</p>
