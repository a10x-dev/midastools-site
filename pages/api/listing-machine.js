// ── RETIRED 2026-07-19 — Listing Machine (legacy free tool).
//
...
// keeps its own Anthropic implementation. Stripped so no path here can ever
// spend, even if a guard is deleted. Restore from git to revive.
